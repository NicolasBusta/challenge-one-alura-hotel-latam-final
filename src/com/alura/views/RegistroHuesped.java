...
public class RegistroHuesped extends JFrame {
	...
	//	generarNumeroReserva();
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			/*	String nombre = txtNombre.getText();
		        ...
		        String nReservaText = txtNreserva.getText();
		        
		        
		     // Verificar si todos los campos están llenos
		        if (nombre.isEmpty() || apellido.isEmpty() || fechaNacimiento == null || nacionalidad.isEmpty() || telefono.isEmpty()) {
		            JOptionPane.showMessageDialog(null, "Falta un espacio por llenar");
		            return;
		        }

		        // Verificar si los campos txtTelefono y txtNreserva contienen solo números
		        if (!telefono.matches("\\d+")) {
		            JOptionPane.showMessageDialog(null, "El campo Teléfono debe contener solo números");
		            return;
		        }

		     // Generar el número de reserva antes de crear la nueva reserva
		       // generarNumeroReserva();
		        int nReserva = Integer.parseInt(nReservaText);
		        nReserva = GeneradorReservas.generarNumeroReserva();

		        Reserva reserva = new Reserva(id, fechaNacimiento, fechaNacimiento, nReservaText, id)
		        System.out.println(reserva);
		        guardarHuesped(reserva);
	...
	/*private void guardarHuesped() {
	    ...
	    // Generar un número aleatorio entre 1 y 1000000 (ambos inclusive)
	    int idReserva = rand.nextInt(1000000) + 1;
	    
	 // Mostrar el ID de reserva generado en la vista
	    txtNreserva.setText(String.valueOf(idReserva));

	    // Obtener los datos del huésped desde la interfaz de usuario
	    String nombre = txtNombre.getText();
	    String apellido = txtApellido.getText();
	    Date fechaNacimiento = txtFechaN.getDate();
	    String nacionalidad = (String)txtNacionalidad.getSelectedItem();
	    ...
	    // Crear un objeto Huesped con los datos del huésped
	    Huesped huesped = new Huesped(nombre, apellido, fechaNacimiento, nacionalidad, telefono, idReserva);

	    // Llamar al método guardarHuesped del controlador para guardar el objeto Huesped en la base de datos

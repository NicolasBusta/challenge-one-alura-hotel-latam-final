...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				costoEstadia(txtFechaEntrada, txtFechaSalida);
		...
		// Agregar un JLabel con el texto deseado al panel btnsiguiente
		JLabel lblTexto = new JLabel("Siguiente");
		lblTexto.setHorizontalAlignment(SwingConstants.CENTER);
		lblTexto.setFont(new Font("Roboto Black", Font.BOLD, 17));
		lblTexto.setBounds(0, 0, 122, 35);
		lblTexto.setForeground(Color.WHITE);
		btnsiguiente.add(lblTexto);
	...
	private void guardarReserva() {
	    ...
	    Reserva nuevaReserva = new Reserva(
	        java.sql.Date.valueOf(fechaEntrada),
	...
	private void costoEstadia(JDateChooser fechaEntrada,JDateChooser fechaSalida) {		
		if (fechaEntrada.getDate() != null && fechaSalida.getDate() != null) {
	        long diferencia = fechaSalida.getDate().getTime() - fechaEntrada.getDate().getTime();
	        int dias = (int) TimeUnit.DAYS.convert(diferencia, TimeUnit.MILLISECONDS);
	        int diaria = 100;
...
/*	private void btnGuardarActionPerformed(ActionEvent evt) {
	    // Obtener los datos de la reserva desde la interfaz de usuario
	    ...
	    // Generar un número al azar para usar como el id de la reserva
	    int idReserva = GeneradorReservas.generarNumeroReserva();

	    Reserva reserva = new Reserva(fechaEntrada, fechaSalida, valor, formaPago, idReserva);

	    // Llamar al método guardarReserva del controlador para guardar los datos de la reserva en la base de datos
...
*/
	...
	private void btnGuardarActionPerformed(ActionEvent evt) {
	    ...
	    // Obtener numeros random para la resarva:
	    Random rand = new Random();
	    int numReserva = rand.nextInt(1000) + 1;

	    // Crear un objeto Reserva con los datos de la reserva
	    Reserva reserva = new Reserva(fechaEntrada, fechaSalida, valor, formaPago, numReserva);

	    // Obtener el objeto Huesped desde la vista de huespedes
	    Huesped huesped = new Huesped(formaPago, formaPago, fechaSalida, valor, formaPago, numReserva);

	    // Llamar al método guardarReserva del controlador para guardar los datos de la reserva y el huesped en la base de datos
	    reservaController.guardarReserva(reserva, huesped);
